  ...
  if (collapsible === "none") {
    return (
      <div
        data-slot="sidebar"
        className={cn(
          // v3 bracket arbitrary-value syntax — this project is on Tailwind 3.4 but the
          // base-nova registry ships v4's `w-(--var)` parenthesis shorthand, which v3
          // silently drops (→ width:0). See the sidebar-gap/container widths below too.
